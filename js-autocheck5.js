...
// }
// new Car()
// console.log(new  Car('Renault','Capture','800 000 UAH'))
...
// console.log(newCar.changePrice('300UAH'))
...
//     for (let item = 0; item <= this.items.length; item+=1)
//       if (this.items[item] === itemToRemove) {
...
// // console.log(storage.getItems("Droid")); // ["Nanitoids", "Prolonger", "Antigravitator", "Droid"]
// storage.removeItem("Prolonger");
// console.log(storage.getItems("Prolonger")); // ["Nanitoids", "Antigravitator", "Droid"]
...
// car1.getBrand({ brand: "Audi", model: "Q3", price: 36000 })
// // console.log(car1.getBrand({ brand: "Audi", model: "Q3", price: 36000 }))

// car1.changeBrand('Renault')
// console.log(car1.getBrand('Renault'))
